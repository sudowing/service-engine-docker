...
copy(`${migratrionDirectory}/knex.migration_by_sql_dir.template`, `${migratrionDirectory}/${migration_name}.js`);

copyDir(`${migratrionDirectory}/template`, `${migratrionDirectory}/sql/${id}`);
